...
8. **IPreviewCard (Интерфейс)**  
Превью карточки  
   - description: HTMLElement;
   - buyButton: HTMLButtonElement;


9. **IAppState (Интерфейс)**  
...
10. **ICardActions (Интерфейс)**  
действия карточек  
   - onClick: (event: MouseEvent) => void;


11. **IBasketState (Интерфейс)**  
состояние корзины  
   - basketArray: ICardItem[];


12. **IBasketView (Интерфейс)**  
корзина  
   - ul: HTMLElement[];
   - counter: number;


13. **IBasketActions (Интерфейс)**  
действия корзины  
   - onClick: (event: MouseEvent) => void;


14. **IModalData (Интерфейс)**  
модальное окно  
   - content: HTMLElement;


15. **ISuccessPage (Интерфейс)**  
страница успеха  
   - onClick: (event: MouseEvent) => void;


16. **IFormState (Интерфейс)**  
состояние формы  
   - valid: boolean;
   - errors: string[];
